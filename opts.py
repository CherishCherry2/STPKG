...
parser.add_argument("--mode", default="train", help="select action: [\"train\", \
                    \"predict\", \"train_eval\"]")
...
parser.add_argument("--split", default="2", help='split number')
...
#Model parameters
parser.add_argument("--seg", action='store_true', default=True,help='action segmentation')
parser.add_argument("--anticipate", action='store_true', default=True,help='future anticipation')
parser.add_argument("--pos_emb", action='store_true', default=True,help='positional embedding')
parser.add_argument("--max_pos_len", type=int, default=3100, help='position embedding number for linear interpolation')
